...
- пиковая производительность ≈**297,0 тыс. канд/с**
- среднее `T(2N)/T(N) ≈ 2,00`
- разброс построчной пропускной способности — от 281,6 до 301,7 тыс. канд/сек (max/min ≈ 1,07, то есть ±7 %).
...
`T(N) ≈ k·N` с `k ≈ 3,44·10⁻⁶ сек/канд` (по всем 13 точкам `k` принадлежит диапазону: 3,31·10⁻⁶ – 3,55·10⁻⁶). Отклонений от линейности не видно на всём диапазоне данных.

### Пропускная способность

<img width="1280" height="720" src="figures/throughput_by_size.png" alt="Последовательная производительность" />

График колеблется в диапазоне 281,6–301,7 тыс. канд/сек без выраженного тренда по размеру. У малых размеров (1–32) она не выше, а местами ниже, чем на средних и крупных наборов данных. Систематической связи данные не показывают. Разброс ±7 % на всём диапазоне.
