// sha256.hpp — минимальная реализация SHA-256 без внешних зависимостей.
#pragma once
...
public:
    ...
    // Хеш одного куска данных без ручного update()/finalize().
...
private:
    ...
    void transform()
    {
        ...
        auto [a, b, c, d, e, f, g, h] =
            std::tuple{state_[0], state_[1], state_[2], state_[3],
...
// salt + password -> итеративный SHA-256, как описано в config.json датасета.
